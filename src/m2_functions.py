...
def main():
    ...
    """
    print(pythag(3, 4))  # Should print 5
    print(make_turtles('orange', 20))  # Should construct a green thick turtle
    # that goes forward and an orange thin turtle that goes backward
...
def make_turtles(color, thickness):
    ...
    window = rg.TurtleWindow()  # Constructs TurtleWindow

    turtle1 = rg.SimpleTurtle()  # Constructs turtles
    turtle2 = rg.SimpleTurtle()

    turtle1.pen = rg.Pen("green", thickness)  # Setting pen color and width
    turtle2.pen = rg.Pen(color, 5)

    turtle1.forward(100)  # Movement
    turtle2.backward(100)

    window.close_on_mouse_click()  # Stay open until click
